...
public class Player implements WiimoteListener {
	...
	public void onMotionSensingEvent(MotionSensingEvent arg0) {
		...
		if (acc_X.size() == 7 && (acc_X.get(0) < acc_X.get(1))
				&& (acc_X.get(1) < acc_X.get(2))
				&& (acc_X.get(2) < acc_X.get(3))
				&& (acc_X.get(3) < acc_X.get(4))
				&& (acc_X.get(4) < acc_X.get(5))
				&& (acc_X.get(5) < acc_X.get(6)) && (acc_X.get(6) > 2.5f)) {
			setMotionXActive(true);
			acc_X = new ArrayList<Float>();
		}
		if (acc_Y.size() == 7 && (acc_Y.get(0) < acc_Y.get(1))
				&& (acc_Y.get(1) < acc_Y.get(2))
				&& (acc_Y.get(2) < acc_Y.get(3))
				&& (acc_Y.get(3) < acc_Y.get(4))
				&& (acc_Y.get(4) < acc_Y.get(5))
				&& (acc_Y.get(5) < acc_Y.get(6)) && (acc_Y.get(6) > 2.5f)) {
			setMotionYActive(true);
			acc_Y = new ArrayList<Float>();
		}
		if (acc_Z.size() == 7 && (acc_Z.get(0) < acc_Z.get(1))
				&& (acc_Z.get(1) < acc_Z.get(2))
				&& (acc_Z.get(2) < acc_Z.get(3))
				&& (acc_Z.get(3) < acc_Z.get(4))
				&& (acc_Z.get(4) < acc_Z.get(5))
				&& (acc_Z.get(5) < acc_Z.get(6)) && (acc_Z.get(6) > 2.5f)) {
